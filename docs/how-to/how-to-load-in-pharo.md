# How to load Persistent API Skeleton in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      ...
      repository: 'github://mercap/Persistent-API-Skeleton:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `mercap` as owner name and `Persistent-API-Skeleton`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Persistent-API-Skeleton ...*
